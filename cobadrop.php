    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <!--need to prevent parent from being clickable on ipad. Doesn't matter if it isn't as always click to pages in menu. well not always need to add pages for project management and ms project, risk etc. - dropdown-toggle diabled needs to be in css for the ipad media query-->
