...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <a class="navbar-brand" href="index.html"><img src="images/logo-diklatpro.png" width="170"></a>
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
        <nav class="linkEffects linkHoverEffect_12">
            <ul>
                <li><a class="scroll" href="index.php#whatis" data-hover="Tentang Kami">Tentang Kami</a></li>
                <li>
                    <div class="dropdown">
                ...
                Dropdown <span class="caret"></span>
                        ...
                        <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                            <li class="dropdown-submenu">
                                <a tabindex="-1" href="#">Public Training</a>
                                <ul class="dropdown-menu">
                                    <li><a href="#">HACCP</a></li>
                                    <li><a href="#">ISO 22000</a></li>
                                    <li><a href="#">Makanan/Produk Halal</a></li>
                                </ul>
                            </li>
                            <li><a href="#">In-House Training</a></li>
                            <li class="divider"></li>
                            <li><a href="#">Lihat Semua Layanan</a></li>
                        </ul>
                    </div>
                </li>
